...
<head>
    ...
    <title>Bengal Hotel - Contact</title>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6  mb-5 px-4 ">
                ...
                <div class="bg-white rounded shadow p-4 ">
                    ...
                    <h5>Adress</h5>
                    <a href="https://maps.app.goo.gl/CEq9LCuXc7VwUh8M6" target="_blank" class="d-inline-block text-decoration-none text-dark mb-3">
                    ...
                    <a href="tel:+98044769879" class="d-inline-block mb-2 text-decoration-none text-dark">
                        <i class="bi bi-telephone-fill"></i> +98044769879
                    </a>
                    <br>
                    <a href="tel:+98044769879" class="d-inline-block mb-2 text-decoration-none text-dark">
                        <i class="bi bi-telephone-fill"></i> +98044769879
                    ...
                    <a href="mailto:abc@gmail.com" class="d-inline-block mb-2 text-decoration-none text-dark">
