...
<head>
    ...
    <title>Bengal Hotel</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@100..900&family=Poppins&family=Ubuntu:ital,wght@0,300;0,400;0,500;0,700;1,300;1,400;1,500;1,700&family=Varela+Round&display=swap" rel="stylesheet">
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand me-5 fw-bold h-font" href="index.php">Bengal Hotel</a>
    ...
    <div class="container-fluid bg-white mt-5">
        <div class="row text-center p-4">
            <div class="col-lg-4 p-2">
                <h3 class="h-font fw-bold fs-3 mb-2">Bengal Hotel</h3>
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Illum optio ullam, ex natus possimus dolorum voluptatem
                    cum dolorem earum nihil.</p>
            </div>
            <div class="col-lg-4 p-2">
            ...
            <div class="col-lg-4 p-2">
                ...
                <a href="#" class="d-inline-block mb-2 text-decoration-none text-dark fs-6 p-2">
                    <i class="bi bi-facebook"></i> Facebook
                </a><br>
                <a href="#" class="d-inline-block mb-2 text-decoration-none text-dark fs-6 p-2">
                    <i class="bi bi-twitter"></i> Twitter
                ...
                <a href="#" class="d-inline-block mb-2 text-decoration-none text-dark fs-6 p-2">
                    <i class="bi bi-instgram"></i> Instagram
                </a><br>
            </div>
        </div>
    ...
    <h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developed by Tumpa Biswas</h6>
